    ...
    const generateAiPackages = (location, capacity, budget) => {
        ...
        if (parseInt(capacity) * 450 > parseInt(budget)) {
            ...
            const aiPackages = [
                {
                    ...
                    capacity: capacity,
                    price: Math.floor(parseInt(capacity) * 500),
                ...
                },
                {
                    ...
                    capacity: capacity,
                    price: Math.floor(parseInt(capacity) * 560),
                    cover: "https://i.ibb.co.com/5jsstsm/top-10-event-planner-in-kuwait.jpg",
                    duration: "3 hours",
                },
                {
                    location: location ? `${location} Deluxe` : "Lux City",
                    capacity: parseInt(capacity) ? Math.floor(parseInt(capacity) * 0.8) : 80,
                    price: parseInt(budget) ? Math.floor(parseInt(budget) * 0.8) : 40000,
                    cover: "https://i.ibb.co.com/5jsstsm/top-10-event-planner-in-kuwait.jpg",
                    duration: "5 hours",
                },
                {
                    location: location ? `${location} Deluxe` : "Lux City",
                    capacity: parseInt(capacity) ? Math.floor(parseInt(capacity) * 0.9) : 90,
                    price: parseInt(budget) ? Math.floor(parseInt(budget) * 0.9) : 45000,
                    cover: "https://i.ibb.co.com/5jsstsm/top-10-event-planner-in-kuwait.jpg",
                    duration: "5 hours",
                },
                {
                ...
                {
                    location: location ? `${location} Deluxe` : "Lux City",
                    capacity: parseInt(capacity) ? Math.floor(parseInt(capacity) * 1.2) : 120,
                    price: parseInt(budget) ? Math.floor(parseInt(budget) * 1.2) : 60000,
                    cover: "https://i.ibb.co.com/5jsstsm/top-10-event-planner-in-kuwait.jpg",
                    duration: "5 hours",
                },
                {
                    location: location ? `${location} Deluxe` : "Lux City",
                    capacity: parseInt(capacity) ? Math.floor(parseInt(capacity) * 1.35) : 130,
                    price: parseInt(budget) ? Math.floor(parseInt(budget) * 1.35) : 67500,
                    cover: "https://i.ibb.co.com/5jsstsm/top-10-event-planner-in-kuwait.jpg",
                    duration: "5 hours",
                },
                {
                    location: location ? `${location} Deluxe` : "Lux City",
                    capacity: parseInt(capacity) ? Math.floor(parseInt(capacity) * 1.5) : 150,
                    price: parseInt(budget) ? Math.floor(parseInt(budget) * 1.5) : 75000,
                    cover: "https://i.ibb.co.com/5jsstsm/top-10-event-planner-in-kuwait.jpg",
                    duration: "5 hours",
                },
            ];
            ...
            const aiPackages = [
                {
                    location: location ? `${location} Deluxe` : "Lux City",
                    capacity: Math.floor(parseInt(budget) / 500),
                    price: budget,
                    cover: "https://i.ibb.co.com/5jsstsm/top-10-event-planner-in-kuwait.jpg",
                    duration: "5 hours",
                },
                {
                    location: location || "Random City",
                    capacity: Math.floor(parseInt(budget) / 560),
                    price: budget,
                    cover: "https://i.ibb.co.com/5jsstsm/top-10-event-planner-in-kuwait.jpg",
                    duration: "3 hours",
                },
